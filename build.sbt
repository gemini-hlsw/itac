...
lazy val engine = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "edu.gemini.ocs"          %% "edu-gemini-model-p1"         % "2025001.1.1",
      "edu.gemini.ocs"          %% "edu-gemini-shared-skyobject" % "2025001.1.1",
      "edu.gemini.ocs"          %% "edu-gemini-util-skycalc"     % "2025001.1.1",
...
lazy val main = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.apache.poi"                % "poi"                    % "5.4.1",  // over here too jeebus
