...
lazy val engine = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "edu.gemini.ocs"          %% "edu-gemini-model-p1"         % "2025102.1.1",
      "edu.gemini.ocs"          %% "edu-gemini-shared-skyobject" % "2025101.1.1",
      "edu.gemini.ocs"          %% "edu-gemini-util-skycalc"     % "2025101.1.1",
