...
lazy val engine = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "edu.gemini.ocs"          %% "edu-gemini-model-p1"         % "2024102.2.1",
      "edu.gemini.ocs"          %% "edu-gemini-shared-skyobject" % "2024101.1.3",
      "edu.gemini.ocs"          %% "edu-gemini-util-skycalc"     % "2024101.1.3",
...
lazy val main = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.apache.velocity"           % "velocity-engine-core"   % "2.4.1",    // save me jeebus
