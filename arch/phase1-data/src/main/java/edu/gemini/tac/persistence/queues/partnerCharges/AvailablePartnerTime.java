...
public class AvailablePartnerTime extends PartnerCharge {

	protected AvailablePartnerTime() {};

	public AvailablePartnerTime(final Queue queue, final Partner partner, final TimeAmount charge) {
