...
//   private def mkProp(partner: Partner, propTimeHours: Int, id: String): Proposal = {
...
//     Proposal(ntac, site = Site.GS)
//   }

//   private def mkProp(propTimeHours: Int, id: String): Proposal =
//     mkProp(KR, propTimeHours, id)

//   private def mkB3Prop(propTimeHours: Int, id: String): Proposal = {
//     val ntac = Ntac(KR, id, 0, Time.hours(propTimeHours))
//     val b3 = Band3(obsConds)

//     Proposal(ntac, site = Site.GS, band3Observations = List(mkObservation))
//   }
...
//       ExplicitQueueTime(
//         Map[(Partner, QueueBand), Time](
//           (US, QueueBand.QBand1) -> Time.hours(100) * Fixture.Band1Percent,
//           (US, QueueBand.QBand2) -> Time.hours(100) * Fixture.Band2Percent,
//           (US, QueueBand.QBand3) -> Time.hours(100) * Fixture.Band3Percent,
//         ),
//         Map.empty
//       )
//     )
...
//     assertEquals(BoundedTime(Time.hours(100)), qs.bounds(KR))
//     assertEquals(BoundedTime(Time.hours(80)), qs.bounds(Guaranteed, KR))
...
//     assertEquals(BoundedTime(Time.hours(30)), qs.bounds(QueueBand.QBand1, KR))
//     assertEquals(BoundedTime(Time.hours(30)), qs.bounds(QueueBand.QBand2, KR))
//     assertEquals(BoundedTime(Time.hours(20)), qs.bounds(QueueBand.QBand3, KR))
//     assertEquals(BoundedTime(Time.hours(20)), qs.bounds(QueueBand.QBand4, KR))
...
//     assertEquals(Time.Zero, qs.usedTime(KR))
//     assertEquals(Time.Zero, qs.usedTime(QBand1))
//     assertEquals(Time.Zero, qs.usedTime(Guaranteed))
//     assertEquals(Time.Zero, qs.usedTime(QBand1, KR))
//     assertEquals(Time.Zero, qs.usedTime(Guaranteed, KR))

//     assertEquals(Time.hours(100), qs.remainingTime)
//     assertEquals(Time.hours(100), qs.remainingTime(KR))
//     assertEquals(Time.hours(80), qs.remainingTime(Guaranteed))
//     assertEquals(Time.hours(80), qs.remainingTime(Guaranteed, KR))
...
//     assertEquals(Time.hours(100), qs.remainingTime(KR))
//     assertEquals(Time.hours(80), qs.remainingTime(Guaranteed, KR))
//     assertEquals(Time.hours(10), qs1.usedTime(KR))
//     assertEquals(Time.hours(90), qs1.remainingTime(KR))
//     assertEquals(Time.hours(70), qs1.remainingTime(Guaranteed, KR))
...
//     assertEquals(BoundedTime(Time.hours(100), Time.hours(10)), qs1.bounds(KR))
//     assertEquals(BoundedTime(Time.hours(80), Time.hours(10)), qs1.bounds(Guaranteed, KR))
...
//     assertEquals(BoundedTime(Time.hours(30), Time.hours(10)), qs1.bounds(QBand1, KR))
//     assertEquals(BoundedTime(Time.hours(30)), qs1.bounds(QBand2, KR))
//     assertEquals(BoundedTime(Time.hours(20)), qs1.bounds(QBand3, KR))
...
//     val qs1 = qs :+ prop_b1
//     assertEquals(Time.hours(60), qs1.usedTime(KR))
//     assertEquals(Time.hours(40), qs1.remainingTime(KR))
//     assertEquals(Time.hours(20), qs1.remainingTime(Guaranteed, KR))
//     assertEquals(QBand3, qs1.band)
...
//     val qs3 = qs1 :+ prop_b3
//     assertEquals(Time.hours(70), qs3.usedTime(KR))
//     assertEquals(Time.hours(30), qs3.remainingTime(KR))
//     assertEquals(Time.hours(10), qs3.remainingTime(Guaranteed, KR))
...
//     assertEquals(Time.hours(3), qs2.usedTime(KR))
